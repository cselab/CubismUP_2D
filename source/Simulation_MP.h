...
#ifndef __CubismUP_2D__Simulation_MP__
#define __CubismUP_2D__Simulation_MP__
...
public:
	Simulation_MP(const int argc, const char ** argv) : Simulation_Fluid(argc, argv), gravity{0,-9.81}, dtCFL(0), dtFourier(0), re(0), nu(0), minRho(0), rhoS(1), bSplit(false)
	{
