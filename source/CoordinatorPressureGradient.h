...
#ifndef __CubismUP_2D__CoordinatorPressureGradient__
#define __CubismUP_2D__CoordinatorPressureGradient__
...
#endif /* defined(__CubismUP_2D__CoordinatorPressureGradient__) */
