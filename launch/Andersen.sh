...
make config=production poisson=split-fftw bc=mixed precision=double particles=false rk2=true dlm=true -j
cd ../launch

for D in 1.0
#0.5 0.75 1.0 1.25 1.5 1.75 2.0 5.0
do
for P in .2 .5 .8
#.1 .09 .11 .15 .2
do
...
#32 64 128
do
	BASENAME=Andersen_16032016_Re1100_mixed_long_DLM${D}_CFL${CFL}_bpd${BPD}_${P}
...
export OMP_NUM_THREADS=48;bsub -n 48 -W 168:00 -o ${BASENAME}_T -J ${BASENAME}_T ./simulation_T -file ${FOLDER}/${BASENAME}_T -CFL ${CFL} -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 2.7 -ypos .9 -xpos ${P} -nu 0.000018382931330804 -sim falling -shape ellipse -semiAxisX 0.003125 -semiAxisY 0.025 -angle 0.2 -dlm ${D}
#export OMP_NUM_THREADS=48;./simulation_T -file ${FOLDER}/${BASENAME}_T -CFL ${CFL} -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 2.7 -ypos .9 -xpos ${P} -nu 0.000018382931330804 -sim falling -shape ellipse -semiAxisX 0.003125 -semiAxisY 0.025 -angle 0.2 -dlm ${D}
