...
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 4 -maxBPD 4 -test advection -ic 0 -minDT 0.000001 -maxDT 0.0001 -tEnd 0.01
...
export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 8 -test advection -ic 1 -minDT 0.00001 -maxDT 0.001 -tEnd 0.01
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 8 -test advection -ic 1 -minDT 0.000001 -maxDT 0.000001 -tEnd 0.01