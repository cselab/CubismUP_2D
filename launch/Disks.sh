...
do
	../makefiles/test -file /cluster/scratch_xp/public/cconti/CubismUP/Disk_rhoS${R} -CFL 0.1 -LCFL 0.1 -minBPD 4 -maxBPD 64 -test addedmass -rhoS ${R} -radius 0.05 -nu 0.001 -nsteps 1
