...
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 64 -test poisson -ic 1 > results_poisson_solver2_ic1
...
#make config=production poisson=hypre bc=periodic precision=double bs=32 -j
#cd ../launch/
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 64 -test pressure -solver 2 -ic 0 > results_pressure_solver2_ic0
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 64 -test pressure -solver 2 -ic 1 > results_pressure_solver2_ic1
...
#cd ../launch/
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 64 -test pressure -solver 2 -ic 2 > results_pressure_solver2_ic2
#export OMP_NUM_THREADS=48;../makefiles/test -minBPD 8 -maxBPD 64 -test poisson -ic 0 > results_poisson_ic0
