...
#export OMP_NUM_THREADS=48;bsub -n 48 -W 10:00 -o ${BASENAME}${BPD}_ic1_0 -J ${BASENAME}${BPD}_ic1_0 mpirun -np 32 ${FOLDER_1}/simulation -file ${FOLDER_1}/${BASENAME}${BPD}_ic1 -CFL 0.1 -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 1.1 -ypos .9 -nu 0.0000783022988168292 -sim falling -shape ellipse -semiAxisX .00625 -semiAxisY .025 -angle 0.79 -tdump 0.025
export OMP_NUM_THREADS=48;bsub -n 48 -W 168:00 -o ${BASENAME}${BPD}_ic2_0 -J ${BASENAME}${BPD}_ic2_0 mpirun -np 32 ${FOLDER_2}/simulation -file ${FOLDER_2}/${BASENAME}${BPD}_ic2 -CFL 0.1 -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 1.538 -ypos .9 -nu 0.0000141627381528123 -sim falling -shape ellipse -semiAxisX .005 -semiAxisY .025 -angle 0.79 -tdump 0.025
export OMP_NUM_THREADS=48;bsub -n 48 -W 168:00 -o ${BASENAME}${BPD}_ic3_0 -J ${BASENAME}${BPD}_ic3_0 mpirun -np 32 ${FOLDER_3}/simulation -file ${FOLDER_3}/${BASENAME}${BPD}_ic3 -CFL 0.1 -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 1.1 -ypos .9 -nu 0.00000783022988168292 -sim falling -shape ellipse -semiAxisX .00625 -semiAxisY .025 -angle 0.79 -tdump 0.025
export OMP_NUM_THREADS=48;bsub -n 48 -W 168:00 -o ${BASENAME}${BPD}_ic4_0 -J ${BASENAME}${BPD}_ic4_0 mpirun -np 32 ${FOLDER_4}/simulation -file ${FOLDER_4}/${BASENAME}${BPD}_ic4 -CFL 0.1 -bpdx ${BPD} -bpdy ${BPD} -tend 200. -rhoS 1.248 -ypos .9 -nu 0.00000985240110463296 -sim falling -shape ellipse -semiAxisX .0125 -semiAxisY .025 -angle 0.79 -tdump 0.025
