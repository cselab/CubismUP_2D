cd ../makefiles
make clean
make config=production poisson=split-fftw bc=openbox precision=single rk2=false particles=false dlm=true -j
cd ../launch

FOLDER=/cluster/scratch_xp/public/cconti/CubismUP/Thesis/GlowinskiLee_Euler_22032016
mkdir ${FOLDER}
cp ../makefiles/simulation ${FOLDER}
cp ThesisGlowinskiEuler.sh ${FOLDER}
...
#4 8 16 32 64
do
	NAME=GlowinskiLee_bpdx${BPD}_CFL${C}_DLM${D}
...
bsub -n 48 -W 10:00 -o ${NAME} -J ${NAME} ${FOLDER}/simulation -file ${FOLDER}/${NAME} -CFL ${C} -bpdx ${BPD} -bpdy $[${BPD}*3] -radius 0.0208333333333333 -tend 5. -rhoS 1.25 -ypos .67 -nu 0.000680413817439772 -sim falling -lambda ${D} -g 9.8
