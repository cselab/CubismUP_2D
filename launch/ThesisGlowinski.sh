cd ../makefiles
make clean
make config=production poisson=split-fftw bc=openbox precision=double rk2=true particles=false dlm=true -j
cd ../launch

FOLDER=/cluster/scratch_xp/public/cconti/CubismUP/Thesis/GlowinskiLee_24012016
mkdir ${FOLDER}
cp ../makefiles/simulation ${FOLDER}
cp ThesisGlowinski.sh ${FOLDER}
