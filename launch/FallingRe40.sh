...
#8 16 32
		do
			NAME=Falling_DCT_Re40_2810_DLM10_bpd${BPD}_CFL${C}
            ...
            bsub -n 48 -W 10:00 -o ${NAME} -J ${NAME} ./simulation -file ${FOLDER}/${NAME} -CFL ${C} -LCFL ${C} -bpdx ${BPD} -bpdy $[${BPD}*4] -radius .025 -tend 2. -rhoS 2. -ypos .9 -nu 0.000846515308813225 -sim falling -lambda ${L}
            cd -
		done
	done
done
