...
#8 16 32
		do
			NAME=Falling_DCT_Re40_2710_diff2nd_PressureBody_Lambda${L}_bpd${BPD}_CFL${C}
            ...
            bsub -n 48 -W 40:00 -o ${NAME} -J ${NAME} ./simulation -file ${FOLDER}/${NAME} -CFL ${C} -LCFL ${C} -bpdx ${BPD} -bpdy $[${BPD}*4] -radius .025 -tend 2. -rhoS 2. -ypos .9 -nu 0.000846515308813225 -sim falling -tdump 0.025 -lambda ${L}
            cd -
		done
	done
done
